...
def selfcal_part1():
    ...
    if not os.path.exists(pybdsf_imagename+'-image.fits'):
        ...
        if use_tclean == True:
            ...
            #     gridder='standard',weighting='briggs',robust=0.5,niter=0, datacolumn='data',
            #     parallel=parallel,
...
def selfcal_part2():
    ...
    pybdsf_imagename = source.replace('.ms','')+'_pybdsf'
    regionfile = pybdsf_imagename+'.fits.casabox'
        ...
        if os.path.exists(imagename):
            ...
            if use_tclean == True:
                tclean(
                    ...
                    gridder='standard',weighting='natural', niter=niter,
                    nsigma = float(threshold[selfcal_loop]), 
                    usemask='user',
                    mask=regionfile,
                    # usemask='auto-multithresh',
                    parallel=parallel
